...
tf.flags.DEFINE_string('input_dir', 'samples/mitosis/batch_input/', 'input image path (.jpg)')
tf.flags.DEFINE_string('output_dir', 'samples/mitosis/batch_output/', 'output image path (.jpg)')
